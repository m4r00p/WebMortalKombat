app.core.Object.define("app.view.Character", {
    ...
    members: {
        ...
        _onChangeState: function (data) {
            ...
            if (!app.view.Character.loadedState) {
                app.view.Character.loadedState = [];
            }

            if (app.view.Character.loadedState.indexOf(data[0]) === -1) {
                this.loadStylesheet('css/' + fileName + '.css');
                app.view.Character.loadedState.push(data[0]);
            } 
